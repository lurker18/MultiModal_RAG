...
def load_model(model_name):
    if model_name == "facebook/rag-sequence-nq":
        model_name = "/home/utopiamath/.cache/huggingface/hub/models--facebook--rag-sequence-nq/snapshots/c0d9c6ceda8a69c78091abb7aa734a97b75b89fd/"

    retriever = RagRetriever.from_pretrained(model_name, dataset='wiki_dpr', index_name='compressed', local_files_only=True, download_config='/home/utopiamath/Downloads')
